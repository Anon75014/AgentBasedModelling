...
\rhead{\footnotesize Golling, Mourouga, Moser, Author 4, Author 5} %<---- Fill in your lastnames.
...
In order to illustrate the development of a farm-level agent-based model applied to agricultural systems, the model development is organised in versions, starting from the simple, deterministic \tagg{v1.0} on top of which we progressively implement new features such as market dynamics, weather events and agent personalities.
