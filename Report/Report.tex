...
\pgfplotstableread[col sep=comma]{Data/exported_budget.csv}{\budget}
\pgfplotstableread[col sep=comma, skip first n=3]{Data/exported_stock.csv}{\stock}
...
\begin{subfigure}[hb]{0.5\textwidth}
	\resizebox{\linewidth}{!}{\begin{tikzpicture}
		...
		\begin{axis}[
		  ...
		  \addplot table[y index =5]{\stock};
		  \addlegendentry{$1$}
		  \addplot table[y index =6]{\stock};
		  \addlegendentry{$2$}
		  \addplot table[y index =7]{\stock};
		  \addlegendentry{$3$}
		  \addplot table[y index =8]{\stock};
		  \addlegendentry{$4$}
		\end{axis}
	  \end{tikzpicture}
  }
