...
\begin{frame}{\ba}{\baa}
  ...
  \begin{itemize}
    ...
    \item<4->{The \href{https://github.com/Anon75014/AgentBasedModelling/tree/main/python}{Python code} can be edited to play around with different parameters and equations and a Documentation was created to allow for an easier code review.}
...
\begin{frame}{\ba}{\baa}
  ...
  \begin{itemize}
    ...
    \item<5->{Ecological impact of different crops}
  \end{itemize}
\end{frame}
