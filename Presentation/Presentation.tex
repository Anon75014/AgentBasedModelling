...
\begin{frame}{\aa}{\aaa}
    \begin{columns}
      \column{0.48\linewidth}
         \centering
         \begin{figure}
          \includegraphics[width=\textwidth]{Report/Figures/v11_Map.png}
         \end{figure}
...
\pgfplotstableread[col sep=comma]{Report/Data/v11_exported_budget.csv}{\budgeta}
\pgfplotstableread[col sep=comma, skip first n=3]{Report/Data/v11_exported_stock.csv}{\stocka}
...
\pgfplotstableread[col sep=comma]{Report/Data/v12_exported_budget.csv}{\budgetb}
\pgfplotstableread[col sep=comma, skip first n=3]{Report/Data/v12_exported_stock.csv}{\stockb}
\pgfplotstableread[col sep=comma, skip first n=1]{Report/Data/v12_exported_cellcount.csv}{\cellcountb}
...
\pgfplotstableread[col sep=comma]{Report/Data/v12_exported_budget_50t.csv}{\budgetc}
\pgfplotstableread[col sep=comma, skip first n=3]{Report/Data/v12_exported_stock_50t.csv}{\stockc}
\pgfplotstableread[col sep=comma, skip first n=1]{Report/Data/v12_exported_cellcount_50t.csv}{\cellcountc}
...
\pgfplotstableread[col sep=comma]{Report/Data/v13_exported_budget.csv}{\budgetc}
\pgfplotstableread[col sep=comma, skip first n=3]{Report/Data/v13_exported_stock.csv}{\stockc}
\pgfplotstableread[col sep=comma, skip first n=1]{Report/Data/v13_exported_cellcount.csv}{\cellcountc}
\pgfplotstableread[col sep=comma]{Report/Data/v13_exported_demand.csv}{\demandc}
\pgfplotstableread[col sep=comma]{Report/Data/v13_exported_prices.csv}{\pricesc}
\pgfplotstableread[col sep=comma]{Report/Data/v13_exported_supply.csv}{\supplyc}
\pgfplotstableread[col sep=comma]{Report/Data/v13_exported_global_stock.csv}{\globalstockc}
...
\begin{figure*}
   \hfill
     ...
     \begin{subfigure}[b]{0.40\textwidth}
         ...
         \centering
         \includegraphics[width=\textwidth]{Presentation/Figures/Emissions-by-sector-–-pie-charts.png}
     \end{subfigure}
 \hfill
